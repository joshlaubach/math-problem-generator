...
export default function TutorLayout({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    function check() {
      setTooNarrow(window.innerWidth < 768)
    }
    check()
    ...
    return (
      <div style={{
        ...
        <h2 style={{
          ...
          Sessions require a tablet or laptop
        </h2>
        <p style={{ fontSize: 14, color: 'var(--text-dim)', lineHeight: 1.65, maxWidth: 320 }}>
          The tutoring interface needs more screen space than a phone can provide. Please open Gradient on a tablet or computer to start a session.
        </p>
      </div>
    )
  }
